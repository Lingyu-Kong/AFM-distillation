...
class StudentPropertyPredictor:
    ...
    def __init__(
        self,
        lightning_module: StudentModuleBase[Any, Any, StudentModuleBaseConfig],
    ...
    def predict(
        ...
        *,
        ...
        properties = _resolve_properties(
            properties, self.lightning_module.hparams)

        # Create a trainer instance.
        trainer = _create_trainer(
            self._lightning_trainer_kwargs, self.lightning_module)
