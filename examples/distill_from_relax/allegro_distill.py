...
def main(args_dict: dict):
    def hparams():
        ...
        hparams.data.train.src = "/net/csefiles/coc-fung-cluster/lingyu/afm_distill/RattleRelax-2026-02-09-19-36-mattersim-1m-best-h2o_1593_train_25/all_data.xyz"
        hparams.data.validation = MC.XYZDatasetConfig.draft()
        hparams.data.validation.src = "../distill_from_md/data/h2o_1593_val_5.xyz"
    ...
    val_atoms_list: list[Atoms] = read(
        "../distill_from_md/data/h2o_1593_test_1563.xyz", ":")  # type: ignore
    ...
    plt.tight_layout()
    plt.savefig("allegro_val_predictions.png", dpi=300)
