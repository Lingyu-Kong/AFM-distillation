...
def main(args_dict: dict):
    ...
    for idx, atoms in enumerate(starting_atoms_list):
        ...
        for sampled in sampled_data:
            if "forces" not in sampled.arrays:
                sampled.arrays["forces"] = sampled.get_forces()
            if "energy" not in sampled.info:
                sampled.info["energy"] = sampled.get_potential_energy()
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--num_trajs", type=int, default=8)
